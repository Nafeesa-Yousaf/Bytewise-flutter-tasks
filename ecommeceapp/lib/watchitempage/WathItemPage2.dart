...
class WatchItemPage2 extends StatefulWidget {
  @override
  _WatchItemPage2State createState() => _WatchItemPage2State();
}

class _WatchItemPage2State extends State<WatchItemPage2> {
