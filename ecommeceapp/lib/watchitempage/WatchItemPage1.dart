...
class WatchItemPage1 extends StatefulWidget {
  @override
  _WatchItemPage1State createState() => _WatchItemPage1State();
}

class _WatchItemPage1State extends State<WatchItemPage1> {
