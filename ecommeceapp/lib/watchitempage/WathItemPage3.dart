...
class WatchItemPage3 extends StatefulWidget {
  @override
  _WatchItemPage3State createState() => _WatchItemPage3State();
}

class _WatchItemPage3State extends State<WatchItemPage3> {
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 88, 86, 88),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 20, 7, 75),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 196, 119, 18),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
