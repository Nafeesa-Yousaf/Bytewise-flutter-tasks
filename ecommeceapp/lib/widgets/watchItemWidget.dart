...
class watchItemWidget extends StatelessWidget {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            Navigator.pushNamed(context, "WatchItemPage$i");
                          },
                          child: Padding(
                            padding: EdgeInsets.all(10),
                            child: Image.asset(
                              "assets/images/watch$i.png",
                              height: 150,
                              width: 150,
                              fit: BoxFit.contain,
                            ),
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                final item = {
                                  'name': "Storve Watch",
                                  'image': "assets/images/watch$i.png",
                                  'price': "55",
                                };
                                cartBox.add(item);
