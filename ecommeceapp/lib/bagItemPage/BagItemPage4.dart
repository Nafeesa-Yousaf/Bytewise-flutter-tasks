...
class BagItemPage4 extends StatefulWidget {
  @override
  _BagItemPage4State createState() => _BagItemPage4State();
}

class _BagItemPage4State extends State<BagItemPage4> {
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 109, 25, 124),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 22, 5, 97),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 168, 23, 12),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
