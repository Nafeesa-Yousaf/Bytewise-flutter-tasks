...
class SportItemPage3 extends StatefulWidget {
  @override
  _SportItemPage3State createState() => _SportItemPage3State();
}

class _SportItemPage3State extends State<SportItemPage3> {
