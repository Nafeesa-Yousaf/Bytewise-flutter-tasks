...
class SportItemPage1 extends StatefulWidget {
  @override
  _SportItemPage1State createState() => _SportItemPage1State();
}

class _SportItemPage1State extends State<SportItemPage1> {
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              margin: EdgeInsets.symmetric(horizontal: 5),
                              decoration: BoxDecoration(
                                color: Color.fromARGB(255, 76, 76, 78),
                                shape: BoxShape.circle,
                              ),
                            ),
                            Container(
