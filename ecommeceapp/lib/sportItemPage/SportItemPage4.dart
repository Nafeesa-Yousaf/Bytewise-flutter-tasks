...
class SportItemPage4 extends StatefulWidget {
  @override
  _SportItemPage4State createState() => _SportItemPage4State();
}

class _SportItemPage4State extends State<SportItemPage4> {
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          "Shery Best Quality Cricket Helmet",
                          style: TextStyle(
                            fontSize: 26,
